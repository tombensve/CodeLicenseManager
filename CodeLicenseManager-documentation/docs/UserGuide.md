...
__Please Note:__ A previous version of this utility exists on <http://codelicmgr.sf.net/>.
...
* Maven (plugin).
    ...
    * Can resolve project license, third party licenses, copyrights, project description,
    project version, etc from maven pom.
