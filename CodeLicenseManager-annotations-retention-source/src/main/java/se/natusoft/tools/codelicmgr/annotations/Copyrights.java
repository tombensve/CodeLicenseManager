...
/**
 * This specifies a list of copyrights. Some code do change copyright info over time
 * and lists all copyrights. Though it is probably not very common I decided to support
 * it.
 */
@Project(
    name="CodeLicenseManager-annotations-retention-source",
    codeVersion="2.1",
...
@Author(
    name="Tommy Svensson",
    changes={
        @Change(when="2009-11-02", description="Created")
    }
)
...
public @interface Copyrights {
    ...
    /**
     * Takes an array of @Copyright annotations.
     */
    Copyright[] value();
}
