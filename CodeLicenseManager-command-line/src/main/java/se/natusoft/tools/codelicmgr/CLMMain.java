...
@Authors({
    @Author(
        ...
        changes={
            ...
            @Change(when="2010-01-04", description="Help handling was moved to this class since it needed the full classpath " +
                                                    "to also show help for the Configuration model.")
        }
    )
})
