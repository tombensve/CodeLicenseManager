...
@Authors({
    @Author(
        ...
        changes={
            @Change(when="2009-12-27", description="Created"),
            @Change(when="2010-01-04", description="Moved help handlingn to CLMMain since it needed CodeLicenseManager in classpath.")
        }
    )
})
public class Main {
